...
export const TRANSITION_CONFIG = {
  ...
  mode: 'circle' as 'circle' | 'curtain', // Changez à 'curtain' pour revenir au rideau noir
...
export const getTransitionMode = (): 'circle' | 'curtain' => TRANSITION_CONFIG.mode;

// Fonction pour changer le mode dynamiquement
export const setTransitionMode = (newMode: 'circle' | 'curtain'): void => {
