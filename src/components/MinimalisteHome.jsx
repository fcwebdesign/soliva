...
function Hero({ title, subtitle, button1Text, button1Link, button2Text, button2Link }){
  return (
...
function WorkGrid({ items, title, subtitle }){
...
const MinimalisteHome = ({ content, workProjects = [] }) => {
  ...
  const mappedProjects = projects.map(project => {
    ...
    let imageUrl = project.image?.src || 
