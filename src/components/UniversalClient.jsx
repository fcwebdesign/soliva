...
export default function UniversalClient({ content, template = 'default' }) {
  ...
  const blocks = previewContent?.blocks || convertTemplateToBlocks(previewContent, currentTemplate);
