...
import HeaderEffica from './components/Header';
import FooterEffica from './components/Footer';

export default function EfficaClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderEffica nav={content.nav || { logo: 'effica' }} pages={content.pages} />
