...
import HeaderArtcore from './components/Header';
import FooterArtcore from './components/Footer';

export default function ArtcoreClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderArtcore nav={content.nav || { logo: 'artcore' }} pages={content.pages} />
      ...
      <FooterArtcore footer={content.footer} pages={content.pages} />
    </div>
  );
}