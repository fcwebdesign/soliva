...
import HeaderArtboard from './components/Header';
import FooterArtboard from './components/Footer';

export default function ArtboardClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderArtboard nav={content.nav || { logo: 'artboard' }} pages={content.pages} />
      ...
      <FooterArtboard footer={content.footer} pages={content.pages} />
    </div>
  );
}