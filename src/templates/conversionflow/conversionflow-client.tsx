...
import HeaderConversionflow from './components/Header';
import FooterConversionflow from './components/Footer';

export default function ConversionflowClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderConversionflow nav={content.nav || { logo: 'conversionflow' }} pages={content.pages} />
      ...
      <FooterConversionflow footer={content.footer} pages={content.pages} />
    </div>
  );
}