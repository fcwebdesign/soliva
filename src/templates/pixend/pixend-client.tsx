...
import HeaderPixend from './components/Header';
import FooterPixend from './components/Footer';

export default function PixendClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderPixend nav={content.nav || { logo: 'pixend' }} pages={content.pages} />
      ...
      <FooterPixend footer={content.footer} pages={content.pages} />
    </div>
  );
}