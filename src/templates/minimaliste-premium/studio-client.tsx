...
const StudioMinimalisteClient: React.FC = () => {
    ...
    const fetchContent = async () => {
      try {
        ...
        if (previewParam) {
          ...
          console.log('🔍 Mode aperçu détecté (studio minimaliste):', previewParam);
        ...
        console.log('📦 Contenu studio chargé (minimaliste):', data.studio);
        setContent(data);
      } catch (error) {
...
export default StudioMinimalisteClient; 