...
import HeaderSalescore from './components/Header';
import FooterSalescore from './components/Footer';

export default function SalescoreClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderSalescore nav={content.nav || { logo: 'salescore' }} pages={content.pages} />
      ...
      <FooterSalescore footer={content.footer} pages={content.pages} />
    </div>
  );
}