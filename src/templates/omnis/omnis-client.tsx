...
import HeaderOmnis from './components/Header';
import FooterOmnis from './components/Footer';

export default function OmnisClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderOmnis nav={content.nav || { logo: 'omnis' }} pages={content.pages} />
      ...
      <FooterOmnis footer={content.footer} pages={content.pages} />
    </div>
  );
}