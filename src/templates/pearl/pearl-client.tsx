        ...
        {shouldShowReveal && content && (content.nav?.logo || content.nav?.logoImage) && (
          ...
          <main 
            ...
            className={`mx-auto px-4 sm:px-6 lg:px-8 ${
              // Retirer py-8 si le premier bloc est hero-floating-gallery ou mouse-image-gallery
              (() => {
                const blocks = pageData?.blocks || [];
                const firstVisibleBlock = blocks.find((b: any) => !b.hidden);
                return firstVisibleBlock?.type === 'hero-floating-gallery' || firstVisibleBlock?.type === 'mouse-image-gallery' ? '' : 'py-8';
              })()
            } ${
