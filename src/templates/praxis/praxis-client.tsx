...
import PraxisHeader from '@/templates/praxis/components/Header';
import FooterPraxis from '@/templates/praxis/components/Footer';
...
export default function PraxisClient() {
  ...
  // Résoudre la page courante à partir du pathname
  ...
  return (
    <div className="min-h-screen bg-white">
      <PraxisHeader nav={content.nav || { logo: 'praxis' }} pages={content.pages} />
      ...
      <FooterPraxis footer={content.footer} pages={content.pages} />
    </div>
  );
}
