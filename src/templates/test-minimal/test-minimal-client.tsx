...
import HeaderTestminimal from './components/Header';
import FooterTestminimal from './components/Footer';

export default function TestminimalClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderTestminimal nav={content.nav || { logo: 'test-minimal' }} pages={content.pages} />
      ...
      <FooterTestminimal footer={content.footer} pages={content.pages} />
    </div>
  );
}