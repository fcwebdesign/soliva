...
import HeaderDalgona from './components/Header';
import FooterDalgona from './components/Footer';

export default function DalgonaClient() {
  ...
  // Logique de routage (pas de hook pour éviter l'ordre variable)
  const route = (() => {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderDalgona nav={content.nav || { logo: 'dalgona' }} pages={content.pages} />
      ...
      <FooterDalgona footer={content.footer} pages={content.pages} />
    </div>
  );
}
