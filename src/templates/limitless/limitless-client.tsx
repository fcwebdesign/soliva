...
import HeaderLimitless from './components/Header';
import FooterLimitless from './components/Footer';

export default function LimitlessClient() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <HeaderLimitless nav={content.nav || { logo: 'limitless' }} pages={content.pages} />
      ...
      <FooterLimitless footer={content.footer} pages={content.pages} />
    </div>
  );
}