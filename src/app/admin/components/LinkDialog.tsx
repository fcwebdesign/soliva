...
const LinkDialog: React.FC<LinkDialogProps> = ({ isOpen, onClose, onSave, initialHref = '', initialText = '' }) => {
  const [href, setHref] = useState<string>(initialHref);
  const [text, setText] = useState<string>(initialText);
  const [linkKind, setLinkKind] = useState<string>(detectLinkKind(initialHref));
  const [searchQuery, setSearchQuery] = useState<string>('');
  const [showInternalPages, setShowInternalPages] = useState<boolean>(false);
