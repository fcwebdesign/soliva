...
export default function FourColumnsBlock({ data }: { data: FourColumnsData }) {
  ...
  if (!mounted) {
    return <div className="four-columns-section py-28" style={{ minHeight: '200px' }}></div>;
  }
  ...
  return (
    <section className="four-columns-section py-28" data-block-type="four-columns" data-block-theme={blockTheme}>
